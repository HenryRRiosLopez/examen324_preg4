...
echo "</a>";
echo "<a href=homeDoc.php?ci=".$ci."&color=0232d6&nombre=".$nombre.">";
echo "<button>Azul</button>";
echo "</a>";
echo "<a href=homeDoc.php?ci=".$ci."&color=d6dd02&nombre=".$nombre.">";
echo "<button>Amarillo</button>";
echo "</a>";
echo "</br>";
echo "<a href=promedio2.php?ci=".$ci."&color=d6dd02&nombre=".$nombre.">";
